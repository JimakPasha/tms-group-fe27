...
{
   function gameScore(goal1, goal2) {
      let number = {
         0: "zero",
         1: "one",
         2: "two",
      ...
      console.log(`${number[goal1]} : ${number[goal2]}`);
      return
   }
...
// Разобрался, сразу пытался сделать чем-то сложным и вообще упустил из вида опциональную цепочку '?.'
